...
<div class="equipe">
	...
	<h3> Voulez-vous vous rejoindre une équipe? </h3>
		 ...
		 <p>
			...
			<input type="text" name="nomE" required placeholder="durand"/>
			</p>

			<p>
			Entrez le sport de votre équipe:           
			<input type="text" name="sportE" required placeholder="tennis"/>
			</p>

			<p>
			Entrez le mot de passe d'inscription de l'équipe:           
			<input type="password" name="mdpE" required placeholder="toto1234"/>
			</p>
